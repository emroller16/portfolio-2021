    ...
    this.state = {
      data: [
        ...
        },
        {
          ...
          type: 'Design Systems',
          link: 'https://www.figma.com/proto/gypKJeGAe49YQxQ84EWojH/ER-Portfolio?node-id=831%3A2299&scaling=scale-down&page-id=7%3A261&starting-point-node-id=831%3A2299',
        },
        {
          name: 'Team processes',
